...
it("recovers a complete fee projection and returns its exact closure revision without a redundant save", async () => {
  ...
  expect(closure).toEqual({ schoolId, draftId: "fee-draft", expectedRevision: 3 });
