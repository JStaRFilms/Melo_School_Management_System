...
const mockSheets: Record<string, ExamEntrySheetResponse> = {
  [buildSheetKey(
    ...
    roster: [
      createStudent("student_ada", "Ada Nwosu", {
        ca1: 18,
        ca2: 17,
        ca3: 19,
        examRawScore: 34,
      }),
      createStudent("student_tunde", "Tunde Adeyemi"),
      createStudent("student_zainab", "Zainab Bello", {
        ca1: 15,
        ca2: 14,
        ca3: 16,
        examRawScore: 28,
  ...
  return {
    ...
    assessmentRecord: scores
      ? {
          ...
          classId: "class_primary_5a" as Id<"classes">,
...
function createSettings(examInputMode: "raw40" | "raw60_scaled_to_40") {
  return {
