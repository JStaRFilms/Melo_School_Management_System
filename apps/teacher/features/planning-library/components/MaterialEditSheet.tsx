        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="rounded-xl bg-slate-50/50 border border-slate-100 p-4">
             <div className="flex items-center justify-between mb-2">
               ...
               <span className="text-[10px] font-black uppercase tracking-widest text-emerald-600">{material.processingStatus}</span>
             </div>
             <p className="text-[11px] font-medium text-slate-500 leading-relaxed">
               {material.ingestionErrorMessage || "Material processed and indexed for planning context."}
             </p>
             {material.processingStatus === "failed" && (
                <button 
                  onClick={() => onRetry(material._id)}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                onChange={(e) => setDraft({ ...draft, topicLabel: e.target.value })}
          ...
          <div className="pt-6 border-t border-slate-100">
             ...
             <div className="flex flex-col gap-2">
                <button 
                  onClick={() => { if(window.confirm("Archive this material?")) onArchive(material._id); }}
