...
describe("OBHIS navigation", () => {
  test("renders a labelled modal trigger and no mobile dialog until requested", () => {
    const markup = renderToStaticMarkup(<ObhisNavigation name="Approved test identity" homeHref="/" items={[{ href: "/visit", label: "Visit", current: false }]} applicationHref={null} />);
