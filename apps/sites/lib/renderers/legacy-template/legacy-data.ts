...
export const legacyDemoSchools: SchoolConfig[] = [greenfieldSchool, asterPrimarySchool, legacySchool];

/**
 * Compatibility-only fixtures for existing non-production demonstration tenants.
 * They are not published B0 site revisions and must never be used to seed a managed school.
 */
const schools = legacyDemoSchools;
