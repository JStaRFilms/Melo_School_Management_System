...
export const WORKSPACE_CAPABILITY_MATRIX: readonly {
  ...
  { workspace: "admin", path: "/admin/admissions/retention", required: ["enrollment.intakes.manage", "enrollment.decisions.record"] },
  ...
  { workspace: "admin", path: "/admin/admissions", required: ["enrollment.applications.view_basic"] },
