...
const DEMO_SCHOOL_TABLES = [
  ...
  "knowledgeOcrJobs", "knowledgeMaterialChunks", "knowledgeMaterialClassBindings", "knowledgeMaterialFileFingerprints", "knowledgeMaterialUploadIntents", "knowledgeMaterials", "knowledgeTopics",
  ...
  "paymentAllocations", "billingPaymentAttempts", "paymentGatewayEvents", "billingPayments", "studentInvoices", "selectableBillingItems", "selectableBillingCollections", "feePlanApplications", "feePlans", "schoolPaymentProviderSecrets", "schoolPaymentProviders", "schoolBillingSettings",
