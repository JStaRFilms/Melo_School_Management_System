...
| U4 current verified head | `fe9a7f5f202777098e65433e1a2ff3df473157fc` | `feat/melo-productization-u4` | Institutional email policy and import surfaces. |
| U5 current verified head | `383ae787609ac90ed87c983d1504c8fed8e5c44a` | `feat/melo-productization-u5` | Commercial/usage and safe asset lifecycle; upload remains fail-closed. |
| U6 current verified head | `d0ead5f3b63599e4142a15ac48cf421917e9423f` | `feat/melo-productization-u6` | Default-off within-group transfer pilot. |
