...
Dev-data replacement, shipped-core hardening, the cumulative-results backend/UI slice through `T03`, the `T04` historical backfill workflow, the `T07` parent/family linking foundation, `T08` portal MVP academics, `T09` billing and payment foundation, `T13` class-assigned fee plans and student extras, and `T14` school-scoped Paystack/front-desk payment handoff are complete. The next recommended work is `T15` portal billing and self-serve payments. `T16` is now recorded as a later billing hardening slice for cross-device reconciliation edge cases. `T10` public website and SEO surface is now lower priority.
