...
Dev-data replacement, shipped-core hardening, the cumulative-results backend/UI slice through `T03`, the `T04` historical backfill workflow, the `T07` parent/family linking foundation, `T08` portal MVP academics, `T09` billing and payment foundation, `T10` public website and SEO surface, `T13` class-assigned fee plans and student extras, `T14` school-scoped Paystack/front-desk payment handoff, and `T15` portal billing and self-serve payments are complete. The next recommended work is `T11` household management hardening. `T16` remains recorded as a later billing hardening slice for cross-device reconciliation edge cases, `T17` records the platform marketing website lane, `T18` records per-school Paystack credential management and merchant routing, and `T19-T23` now capture the flexible public-web strategy for platform marketing, existing school websites, managed school-site builds, templates, and custom domains.
