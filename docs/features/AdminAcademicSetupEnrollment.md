...
- On admin mobile, roster management now includes direct sheet-based access to `Add Student` and `Edit Student Profile` so subject editing, student creation, and profile updates stay close together.
